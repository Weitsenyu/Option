...
const fmtMin = m => {
  const d = Math.floor(m / 1440),
    ...
    mm = m % 60;
  return `${String(d).padStart(2, "0")}天${String(h).padStart(2, "0")}時${String(mm).padStart(2, "0")}分`;
};
...
export default function App() {
  ...
  /* ---- socket.io 連線 ---- */
  useEffect(() => {
    /* dev 用 localhost，部署後（同網域）直接 io() 就行 */
    const ENDPOINT =
    ...
    <div className="page-container">
      ...
      <div className="left-panel">
        <div className="left-scroll">
          {/* K 線 */}
          <h2 className="panel-title" title="近月 TXF 30 日 K 線與成交量">
            TXF 近月 30 日 K 線
          </h2>
          ...
          <div className="chart-section">
            <h2 className="panel-title" title="未平倉量分佈直方圖">
              OI 直方圖
            </h2>
          ...
          {/* IV Smile */}
          <div className="chart-section">
            <h2 className="panel-title" title="隱含波動率 Smile 曲線">
              IV Smile 曲線
            </h2>
            <div className="chart-header">
          ...
          {/* Profit Distribution */}
          <div className="chart-section">
            <h2 className="panel-title" title="到期損益分佈">
              到期損益分佈
            </h2>
            <div className="chart-header">
      ...
      <div className="center-panel">
        ...
        <Simple
          ...
          tip="距平值兩檔 OTM 合約的時間價值總和"
        />
      </div>

      {/* ------- Right ------- */}
      <div className="right-panel">
        <h2 className="panel-title" title="即時選擇權報價與五檔">
          選擇權鏈
        </h2>
        <OptionChainTable
          socket={socket}
